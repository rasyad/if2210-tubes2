...
import net.oop.raurus.activity.HomeActivity;
import net.oop.raurus.parser.RssAtomParser;
...
import net.oop.raurus.provider.FeedData.TaskColumns;
import net.oop.raurus.utils.ArticleTextExtractor;
...
public class FetcherService extends IntentService {
    ...
    public static final String ACTION_REFRESH_FEEDS = "net.oop.raurus.REFRESH";
    public static final String ACTION_MOBILIZE_FEEDS = "net.oop.raurus.MOBILIZE_FEEDS";
    public static final String ACTION_DOWNLOAD_IMAGES = "net.oop.raurus.DOWNLOAD_IMAGES";
